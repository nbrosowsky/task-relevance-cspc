...
function trial() {
    ...
    if (trialArray[trialCount].target === "quiz") {
        ...
        /* present target stim */
        $(".targetDisplay").hide();
        $(".targetDisplay").html('<img src="' + imgURL + trialArray[trialCount].flanker + '.png"' + '/>' + '<img src="stim_contexts/' + trialArray[trialCount].race + trialArray[trialCount].gender + '.jpg"' + 'style = "width:250px"/>');
        $(".targetDisplay").show();
