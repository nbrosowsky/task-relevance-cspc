...
The results of the RT analysis revealed the critical, two-way interaction between task-relevant context and unbiased-item congruency to be non-significant, `r RT_ANOVA_E3$Task_Relevant_Context`. Similarly, the corresponding error analysis also resulted in a non-significant two-way interaction between the task-relevant context and unbiased-item congruency, `r ACC_ANOVA_E3$Task_Relevant_Context`.
